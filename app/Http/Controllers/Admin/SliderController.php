...
class SliderController extends BaseController
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($sliders)
                ...
                ->addColumn('slider_image', function ($row) {
                    if ($row->slider_image) {
                        return '<img src="' . asset($row->slider_image) . '" width="100" height="auto" alt="Slider Image">';
                    } else {
                ...
                ->rawColumns(['video', 'slider_image', 'action'])
                ->make(true);
        }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'video_url'    => 'nullable|mimes:mp4,mov,ogg,qt|max:51200',
