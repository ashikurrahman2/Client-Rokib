...
@section('content')
    ...
    @foreach($sliders as $slider)
        ...
        <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7">
            {{-- <div class="group">
              ...
              >
                <svg
                  class="group-hover:fill-interface-100 fill-white"
                  width="40"
                  height="40"
                  viewBox="0 0 40 40"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_537_18847)">
                    <path
      ...
      <section class="py-120">
        <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <div
            class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-5 xl:gap-10 lg:gap-16 place-items-center mb-14"
          >
            <div class="xl:col-span-2">
              <h2 class="text-white font-bold lg:text-5xl text-4xl capitalize leading-snug">
                ...
                <span class="relative">
                  ...
                  <svg
                    class="absolute  -left-1 z-0 -top-2 hidden md:block"
                    width="206"
                    height="75"
                    viewBox="0 0 206 75"
                    fill="none"
          ...
          <div class="swiper devServiceSlider">
            <div class="swiper-wrapper pb-10 lg:pb-16">
              <article class="swiper-slide">
                <div
                  class="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom"
                >
                  <div
                    class="w-[70px] h-[70px] rounded-full bg-new-500 group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6"
                  >
                    <svg
                      class="stroke-new-500"
                      width="58"
                      height="58"
                      viewBox="0 0 58 58"
                      fill="none"
                  ...
                  <p class="pb-6 text-white text-base">
                    Creating a higher spacing for people through a unique
                    campaigns Creating a higher people through.
                  </p>
                  <a
                  ...
                  >
                    ...
                    <svg
                      class="stroke-white group-hover:stroke-new-500"
                      width="25"
                      height="26"
                      viewBox="0 0 25 26"
                      fill="none"
                  ...
                  <img
                    ...
                    class="absolute top-5 -right-12 opacity-0 group-hover:opacity-100 transition-opacity"
                    alt=""
                  />
                </div>
              </article>
