    ...
    <div class="modal-body">
        ...
        <div class="col-md-12">
         ...
         <div class="form-group">
            ...
            <img src="{{ asset($slider->slider_image) }}" alt="Brand Logo" class="img-fluid" style="max-width: 100px;">
            @else
            ...
            <div class="form-group">
             <label for="slider_image" class="col-form-label pt-0">Slider Image<sup class="text-size-20 top-1">*</sup></label>
                <input type="file" class="dropify" id="slider_image" name="slider_image" value= "{{ $slider->slider_image }}">
        </div>
